...
const CartPage = () => {
    ...
    return (
        <div className="flex items-center justify-center">
            {!isReviewCompleted && cart.items.length == 0 ? (
                <div className="flex w-screen h-screen items-center justify-center">
                    <div className="flex flex-col space-y-8 items-center justify-center">
                        <Image
                            ...
                            width={500}
                            height={500}
                            src={`/assets/empty-basket.jpg`}
                            alt="login-bg"
                        />
                        <div className="flex flex-col items-center">
                            <p className="text-lg lg:text-xl">Your cart is as empty as my oven</p>
                            <p className="lg:text-lg">Give me something to cook!</p>
                        </div>
                        <Button
                            variant="default"
                            size="sm"
                            asChild
                        >
                            <Link href={`/${lng}/${restaurantId}/menu`}>Browse Menu</Link>
                        </Button>
                    </div>
                </div>
            ) : (
                                    ...
                                    <div className="flex flex-col space-y-6 2xl:space-y-12">
                                        ...
                                        <div className="flex flex-col space-y-4">
                                            <div className="flex flex-row items-center justify-between">
                                                ...
                                                <span
                                                    className="text-sm font-semibold text-gray-700">${parseFloat(subtotal).toFixed(2)}</span>
                                            </div>
                                            <div className="flex flex-row items-center justify-between">
                                            ...
                                            <div className="flex flex-row items-center justify-between">
                                                ...
                                                <span
                                                    className="text-sm font-semibold text-gray-700">${parseFloat(cart.total.toString()).toFixed(2)}</span>
                                            </div>
                                        </div>
