                            ...
                            <TooltipProvider>
                                <Dialog>
                                    ...
                                    <DialogContent>
                                        ...
                                        <DialogDescription>
                                            Modify the worksheet details below. Save your changes or delete the
                                            worksheet if
                                            it
                                            is no longer needed.
                                        </DialogDescription>
                                ...
                                <Dialog>
                                    ...
                                    <DialogContent>
                                        ...
                                        <DialogDescription>
                                            Enter the details of the new menu item, including name, description, and
                                            price.
                                        </DialogDescription>
                                        <hr/>
                                        <div className="overflow-y-auto max-h-[70vh]">
                                            <MenuItemForm restaurantId={selectedRestaurant.id}
